...
def main():
    ...
    upload_button.pack(pady=40, anchor='center')  # Add gap and center align
    ...
    live_detection_button.pack(pady=40, anchor='center')  # Add gap and center align

    # Add an exit button
    exit_button = tk.Button(root, text="Exit", bg="white", fg="brown", command=root.destroy)
    exit_button.pack(pady=40, anchor='center')  # Add gap and center align
